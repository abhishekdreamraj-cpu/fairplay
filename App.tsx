    ...
    <div className="min-h-screen bg-black text-white selection:bg-brand-orange selection:text-white">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="bg-black/80 backdrop-blur-xl border border-white/10 p-12 md:p-20 rounded-[3rem] text-center shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
                <Button text="PLAY NOW @ FAIRPLAY247.GOLD" variant="brand-split" href={REDIRECT_URL} className="text-xl px-12 py-6 shadow-[0_20px_40px_rgba(255,102,0,0.3)] w-full sm:w-auto" />
                <Button text="LOGIN VIA WHATSAPP" variant="secondary" href={WHATSAPP_URL} className="text-xl px-12 py-6 shadow-[0_20px_40px_rgba(0,204,0,0.2)] w-full sm:w-auto" />
              </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 p-4 md:hidden bg-gradient-to-t from-black via-black/80 to-transparent">
        <div className="flex gap-2">
          <Button text="PLAY NOW" variant="brand-split" href={REDIRECT_URL} className="flex-1 py-4 text-[10px] font-black shadow-lg" />
          <Button text="GET ID" variant="secondary" href={WHATSAPP_URL} className="flex-1 py-4 text-[10px] font-black shadow-lg" />
        </div>
      </div>
